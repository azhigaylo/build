...
trap 'on_abort wirelessbridge' ERR SIGQUIT SIGTERM SIGINT
trap 'on_success wirelessbridge' EXIT
on_startup "wirelessbridge"
...
readonly target_name=wirelessbridge
...
cp $module_source_root_path/config/bridge_config_host.json $module_products_root_path
cp $module_source_root_path/config/bridge_config_target.json $module_products_root_path